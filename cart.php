...
<html>
<head>
<title>Sinar Elektro Cikampek - Keranjang Saya</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>BUTUH PERALATAN ELEKTRONIK? YA DI SINAR ELEKTRO CIKAMPEK TEMPATNYA, <a href="products.html">AYO BELANJA SEKARANG!</a></p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6285) 89440 7494</li>
				</ul>
			</div>
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">secikampek@gmail.com</a></li>
