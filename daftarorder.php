...
<html>
<head>
<title>Sinar Elektro Cikampek - Daftar Belanja</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>BUTUH PERALATAN ELEKTRONIK? YA DI SINAR ELEKTRO CIKAMPEK TEMPATNYA, AYO BELANJA SEKARANG!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62) 858 9440 7494</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Sinar Elektro Cikampek</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="daftarorder.php">Daftar Belanja</a></li>
								</ul>
							</div>
							</nav>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jln Ahmad Yani, Cikampek.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">
						secikampek@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 858 9440 7494</li>
					</ul>
				</div>
